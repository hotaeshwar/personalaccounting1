...
const Sidebar = () => {
    ...
    const handleLoanAppNavigation = () => {
        window.open('https://loan.buildingindiadigital.com/', '_blank');
    };
                    ...
                    <nav className="overflow-y-auto" style={{ maxHeight: 'calc(100vh - 80px)' }}>
                        <ul>
                            <li className="transition-all duration-300 hover:bg-gray-700 hover:border-l-4 border-indigo-500 group">
                                <Link 
                                    href="/" 
                                    className={`flex items-center p-3 pl-4 ${isActive('/') ? 'bg-gray-700 border-l-4 border-indigo-500 font-semibold' : ''}`}
                            ...
                            <li className="transition-all duration-300 hover:bg-gray-700 hover:border-l-4 border-indigo-500 group">
                                <Link 
                                    href="/expenses" 
                                    className={`flex items-center p-3 pl-4 ${isActive('/expenses') ? 'bg-gray-700 border-l-4 border-indigo-500 font-semibold' : ''}`}
                                    onClick={() => isMobile && setExpanded(false)}
                                >
                                    <FontAwesomeIcon 
                                        icon={faList} 
                            ...
                            <li className="transition-all duration-300 hover:bg-gray-700 hover:border-l-4 border-indigo-500 group">
                                <Link 
                                    href="/add-expense" 
                                    className={`flex items-center p-3 pl-4 ${isActive('/add-expense') ? 'bg-gray-700 border-l-4 border-indigo-500 font-semibold' : ''}`}
                                    onClick={() => isMobile && setExpanded(false)}
                                >
                                    <FontAwesomeIcon 
                                        icon={faPlus} 
                            ...
                            <li className="transition-all duration-300 hover:bg-gray-700 hover:border-l-4 border-indigo-500 group">
                                <Link 
                                    href="/archive" 
                                    className={`flex items-center p-3 pl-4 ${isActive('/archive') ? 'bg-gray-700 border-l-4 border-indigo-500 font-semibold' : ''}`}
                                    onClick={() => isMobile && setExpanded(false)}
                                >
                                    <FontAwesomeIcon 
                                        icon={faArchive} 
                            ...
                            <li className="transition-all duration-300 hover:bg-gray-700 hover:border-l-4 border-indigo-500 group">
                                <Link 
                                    href="/income" 
                                    className={`flex items-center p-3 pl-4 ${isActive('/income') ? 'bg-gray-700 border-l-4 border-indigo-500 font-semibold' : ''}`}
                                    onClick={() => isMobile && setExpanded(false)}
                                >
                                    <FontAwesomeIcon 
                                        icon={faMoneyBill} 
                            ...
                            <li className="transition-all duration-300 hover:bg-gray-700 hover:border-l-4 border-indigo-500 group">
                                <Link 
                                    href="/profit-loss" 
                                    className={`flex items-center p-3 pl-4 ${isActive('/profit-loss') ? 'bg-gray-700 border-l-4 border-indigo-500 font-semibold' : ''}`}
                                    onClick={() => isMobile && setExpanded(false)}
                                >
                                    <FontAwesomeIcon 
                                        icon={faChartLine} 
                                ...
                                <>
                                    ...
                                    <li className="transition-all duration-300 hover:bg-gray-700 hover:border-l-4 border-green-500 group">
                                        <button 
                                            ...
                                            className="flex items-center p-3 pl-4 w-full text-left cursor-pointer"
                                        >
                                            <FontAwesomeIcon 
                                    ...
                                    <li className="transition-all duration-300 hover:bg-gray-700 hover:border-l-4 border-indigo-500 group">
                                        <Link 
                                            ...
                                            className={`flex items-center p-3 pl-4 ${isActive('/user-transactions') ? 'bg-gray-700 border-l-4 border-indigo-500 font-semibold' : ''}`}
                                            onClick={() => isMobile && setExpanded(false)}
                                        >
                                            <FontAwesomeIcon 
                                                icon={faUsers} 
                                    ...
                                    <li className="transition-all duration-300 hover:bg-gray-700 hover:border-l-4 border-indigo-500 group">
                                        <Link 
                                            href="/export-report" 
                                            className={`flex items-center p-3 pl-4 ${isActive('/export-report') ? 'bg-gray-700 border-l-4 border-indigo-500 font-semibold' : ''}`}
                                            onClick={() => isMobile && setExpanded(false)}
                                        >
                                            <FontAwesomeIcon 
                                                icon={faFileExport} 
