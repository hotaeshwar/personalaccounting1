...
const Header = () => {
        ...
        return (
            <header className="bg-white shadow-md py-2 px-3 sm:px-4 flex justify-between items-center sticky top-0 z-10 border-b border-gray-200 h-14">
                <div className="flex items-center ml-16 sm:ml-20">
                    <img src="/images/LOGO.png" alt="Accounting Logo" className="w-8 h-8 object-contain mr-2" />
    ...
    return (
        <header className="bg-white shadow-md py-2 px-3 sm:px-4 flex justify-between items-center sticky top-0 z-10 border-b border-gray-200 h-14">
            <div className="flex items-center ml-16 sm:ml-20">
                <img src="/images/LOGO.png" alt="Accounting Logo" className="w-8 h-8 object-contain mr-2 hover:rotate-6 transition-transform duration-300" />
                <span className="text-lg sm:text-xl font-bold tracking-tight">
